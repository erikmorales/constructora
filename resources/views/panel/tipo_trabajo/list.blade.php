    ...
    <div class="ms-panel">
        <div class="ms-panel-header ms-panel-custome">
          ...
          <a class="btn btn-pill btn-primary btn-sm"
           href="{{ route('tipo_crear') }}">Agregar tipo trabajador</a>
        </div>
        <div class="ms-panel-body">
          <div class="table-responsive">
            <table id="list-tipo_trabajo" class="table table-striped thead-primary w-100">
              <thead>
                <tr>
                    <th>#</th>
                    <th>Nombre</th>
...
<script>
    $('#list-tipo_trabajo').DataTable( {
        processing: true,
        serverSide: true,
        ajax: "{{ route('listar.tipo_trabajo') }}",
        order: [[ 0, "desc" ]],
        columns: [
            { data: "tipo_trabajo_id", name: "tipo_trabajo_id"},
